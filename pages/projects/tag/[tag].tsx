...
function PostPage({ filteredProjects, tag }) {
  ...
  return (
    ...
    >
      ...
      <Link href="/projects">
        <div className="mt-8 max-w-sm md:max-w-2xl  w-full whitespace-nowrap px-8 py-3 rounded-full text-fun-pink bg-fun-pink-darkerer hover:bg-fun-pink hover:text-white transition-colors cursor-pointer">
